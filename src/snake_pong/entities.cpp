...
e_ball::e_ball()
{
	...
	//add_component<ec_primitive_shape>()->init( primitive_shape::filled_rectangle, w_color::pal( 1 ), w_rect( -e_ball::radius, -e_ball::radius, e_ball::radius * 2.f, e_ball::radius * 2.f ) );
}
