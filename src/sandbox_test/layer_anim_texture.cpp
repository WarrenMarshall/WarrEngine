...
void layer_anim_texture::draw_ui()
{
	...
	{
		//scoped_imgui_location_offset( w_vec2( 56.0f, 32.0f ) );
...
// 		};
//
// 		w_render::draw_sprite( animtex_01->get_texture( 0.0f ), IMGUI->location_offset + w_vec2( 48.0f, 64.0f ) );
// 		w_render::draw_sprite( animtex_coin_01->get_texture( 0.0f ), IMGUI->location_offset + w_vec2( 128.0f, 64.0f ) );
// 		w_render::draw_sprite( animtex_coin_01->get_texture( 0.3f ), IMGUI->location_offset + w_vec2( 160.0f, 64.0f ) );
// 		w_render::draw_sprite( animtex_coin_01->get_texture( 0.6f ), IMGUI->location_offset + w_vec2( 192.0f, 64.0f ) );
	}
