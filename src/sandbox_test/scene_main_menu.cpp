...
void scene_main_menu::draw_ui()
{
...

	{
...

		{
			...
			do_menu_button<scene_simple_collision>( H( "button_simple_collision" ), "Simple Collisions" );
			do_menu_button<scene_simple_collision>( H( "button_simple_triggers" ), "Simple Triggers" );
			do_menu_button<scene_simple_collision>( H( "button_spatial_hash_map" ), "Spatial Hash Map" );
