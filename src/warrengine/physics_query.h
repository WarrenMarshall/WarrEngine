...
struct w_physics_query final
{
	...
	[[nodiscard]] static bool point_check_simple( const w_vec2& pos );
	[[nodiscard]] static bool point_check_simple( const w_vec2& pos, w_query_first* hit_result );
	[[nodiscard]] static bool point_check_all( const w_vec2& pos, w_query_all* hit_result );
};
