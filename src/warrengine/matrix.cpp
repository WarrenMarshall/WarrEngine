...
void Matrix::apply_transform( const Vec2& pos, float_t angle, float_t scale )
{
	apply_transform( pos, angle, { scale, scale } );
}

void Matrix::apply_transform( const Vec2& pos, float_t angle, const Vec2& scale )
{
