...
{
	/*
	[[nodiscard]] static bool trace_simple( const entity* entity, const vec2& start, const vec2& normal, float dist, int32_t collision_mask );
	[[nodiscard]] static bool trace_simple( const vec2& start, const vec2& normal, float dist, int32_t collision_mask, raycast_simple* hit_result );
