...
struct query
{
	...
	[[nodiscard]] static bool point_check_simple( const vec2& pos, query_first* hit_result );
	[[nodiscard]] static bool point_check_all( const vec2& pos, query_all* hit_result );
};
