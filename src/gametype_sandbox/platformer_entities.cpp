...
e_platformer_player::e_platformer_player()
{
	...
	ec->add_fixture_circle( IDF_None, w_vec2::zero, 8.0f );
	ec->add_fixture_box( IDF_PlayerFootSensor, { 0.0f, 8.0f }, 12.0f, 4.0f )
		->SetSensor( true );
	ec->add_fixture_box( IDF_PlayerDropSensor, { 0.0f, 20.0f }, 14.0f, 16.0f )
		->SetSensor( true );
}
